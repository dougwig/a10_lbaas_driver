...
from neutron.tests.unit.db.loadbalancerv2 import test_db_loadbalancerv2

client_path = ('neutron.services.loadbalancer.drivers.a10networks.thunder.'
               ThunderDriver:_get_a10_client)
